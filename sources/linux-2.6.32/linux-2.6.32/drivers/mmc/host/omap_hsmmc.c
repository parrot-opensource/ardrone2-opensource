...
static irqreturn_t omap_hsmmc_irq(int irq, void *dev_id)
{
	...
	err = omap_readl(CM_FCLKEN1_CORE) & status_mask;
	if (!err)
...
#if defined(CONFIG_MACH_OMAP_FC6100) || defined(CONFIG_MACH_OMAP_MYKONOS2)
	/* Limitation of the maximum frequency of the second SDIO controller
