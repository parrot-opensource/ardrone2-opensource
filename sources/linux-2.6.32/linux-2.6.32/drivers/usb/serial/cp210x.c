...
static void cp210x_read_int_callback(struct urb *urb);
...
static struct usb_device_id id_table [] = {
	...
	{ USB_DEVICE(0x19CF, 0x0888) }, /* Parrot Asteroid GPS USB*/
	{ USB_DEVICE(0x19CF, 0x3000) }, /* Parrot AR.Drone GPS USB*/
	{ } /* Terminating Entry */
};
...
static struct usb_serial_driver cp210x_device = {
	...
	.id_table		= id_table,
	.num_ports		= 1,
	.read_int_callback	= cp210x_read_int_callback,
	.open			= cp210x_open,
	.close			= cp210x_close,
...
static int cp210x_open(struct tty_struct *tty, struct usb_serial_port *port)
{
	...
	/*
	 * Parrot anti-nack patch
	 * if there is an interrupt declared in usb_serial.c then submit the urb
	 */

	printk(KERN_WARNING "Parrot Micronesie GPS : with anti-Nack\n");
...
void cp210x_process_read_urb(struct urb *urb)
{
