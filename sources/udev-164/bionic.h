#ifndef UDEV_BIONIC_H
#define UDEV_BIONIC_H
...
static inline int signalfd(int fd, const sigset_t *mask, int flags)
{
	...
	/* use signalfd4 */
	return syscall(355, fd, &sigset[0], sizeof(sigset), flags);
}
...
struct signalfd_siginfo {
	...
	signed int ssi_int;
	unsigned long long int ssi_ptr;
	unsigned long long int ssi_utime;
	unsigned long long int ssi_stime;
	unsigned long long int ssi_addr;
